...
from ppo_gomoku_model_15x15.utils.policy import _policy_t
from ppo_gomoku_model_15x15.utils.log import get_log_func
from ppo_gomoku_model_15x15.utils.augment import augment_transition
...
def round(env: GomokuEnv,
    ...
    Note:
        - If the environment is reset at time t-1, the white player won't make a move at time t. This is different from the black player's behaviour.
